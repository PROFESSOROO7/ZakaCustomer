        ...
        <div className="flex items-stretch justify-center">
            <div className="grid md:grid-cols-2">
                <div className="h-full pr-6">
                    ...
                    Have questions, feedback, or just want to say hello? We're here for you! Contacting Zaka Shoes is easy. Feel free to reach out through the form below or connect with us directly via email or phone. We value your input and look forward to assisting you in any way we can.
                    </p>
                    <ul className="mb-6 md:mb-0">
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">Gujrat</p>
                        ...
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">Mail: zakaUllah@gmail.com</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">Saturday &amp; Sunday: 08:00 - 20:00</p>
                            </div>
                        </li>
                    </ul>
                </div>
